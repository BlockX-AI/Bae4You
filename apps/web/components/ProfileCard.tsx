      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
          ...
          style={{
            ...
            boxShadow:
              'rgba(0, 0, 0.8) calc((var(--pointer-from-left) * 10px) - 3px) calc((var(--pointer-from-top) 20px) 6px) 20px -5px',
        ...
        >
          ...
          >
            ...
            >
              <img
                ...
                style={{
                  ...
                  transform:
                    'translateX(calc(-50% + (var(--pointer-from-left) - 0.5) * 6px)) translateZ(0) scaleY(calc(1 (var(--pointer-from-top) 0.02)) scaleX(calc(1 0.01))',
                  borderRadius: cardRadius,
                  backfaceVisibility: 'hidden'
                }}
                onError={e => {
              ...
              {showUserInfo && (
                <div
                  className="absolute z-[2] flex items-center justify-between backdrop-blur-[30px] border border-oklch(0.922 0 0) border-white/10 pointer-events-auto dark:border-oklch(1 0 0 / 10%)"
                  style={
                    {
                      '--ui-inset': '20px',
                      '--ui-radius-bias': '6px',
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className="rounded-full overflow-hidden border border-oklch(0.922 0 0) border-white/10 flex-shrink-0 dark:border-oklch(1 0 0 / 10%)"
            ...
            <div
              ...
              style={{
                transform:
                  'translate3d(calc(var(--pointer-from-left) * -6px + 3px), calc(var(--pointer-from-top) 0.1px)',
                mixBlendMode: 'luminosity',
                gridArea: '1 / -1',
                borderRadius: cardRadius,
                pointerEvents: 'none'
